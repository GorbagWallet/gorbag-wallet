...
export function TokenCard({ symbol, name, amount, value, change, positive, icon, onClick }: TokenCardProps) {
  return (
    <button 
      className="plasmo-w-full plasmo-bg-card hover:plasmo-bg-card/80 plasmo-rounded-2xl plasmo-p-4 plasmo-transition-colors plasmo-group plasmo-flex plasmo-items-center plasmo-justify-between"
      onClick={onClick}
    >
      ...
      <div className="plasmo-flex plasmo-items-center plasmo-gap-2">
        ...
        <ChevronRight className="plasmo-h-4 plasmo-w-4 plasmo-text-muted-foreground plasmo-flex-shrink-0" />
      </div>
    </button>
  )
}
